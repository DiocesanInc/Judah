...
function acf_hero()
{
    return array(
        ...
        array(
			'key' => 'field_63f50e11ed07e',
			'label' => 'Full Width',
			'name' => 'hero_full_width',
			'aria-label' => '',
			'type' => 'true_false',
			'instructions' => '*Make the hero image slider full width',
			'required' => 0,
        ...
        array(
			...
			'aria-label' => '',
			'type' => 'repeater',
			'instructions' => '*choose the image(s) for the hero. If more than one image is selected the hero will turn into an image slider, Maximum of 5 slides',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
			...
			'sub_fields' => array(
				array(
					...
					'max_size' => '',
					'mime_types' => '',
					'parent_repeater' => 'field_6182f4a8311c2',
				),
				array(
