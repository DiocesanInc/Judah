...
<div class="ministry-slider entry-content max-width">
    ...
    ?>
        <div class="ministry-group equal-height">
            ...
            ?>
                <div class="ministry-wrapper teaser-box has-link" data-excerpt="<?php echo wp_trim_words($excerpt, 25); ?>" data-title="<?php echo $ministry->post_title; ?>" data-image="<?php echo $thumbnail; ?>" data-link="<?php echo get_the_permalink($ministry); ?>" data-contact="<?php echo ""; ?>">
                    <h2><?php echo $ministry->post_title ?></h2>
...
<div id="ministry-lightbox" class="lightbox">
    ...
    <div class="lightbox-content">
        ...
        <?php if ($formId = get_field("ministry_contact_form_id", "options")["id"]) : ?>
