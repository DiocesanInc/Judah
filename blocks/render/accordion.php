...
$headingBackgroundColor = $headingBackgroundColor === "blurred" ? "transparent" : $headingBackgroundColor;
    ...
    <div class="accordion">
        <?php if (have_rows('accordion')) :
            while (have_rows('accordion')) : the_row(); ?>
                <div class="accordion-section-title has-primary-background-color has-white-color<?php echo get_field("accordion_colors", "options")["heading_background_color"] === "blurred" ? " blurred blurred-hover" : ""; ?>">
...
<style type="text/css">
    ...
    #<?php echo "$id .accordion-section-title::after";
