...
{
    echo "<img src=" . get_template_directory_uri() . "/assets/img/evoli_placeholder.png" . " />";
    return;
}
...
{
    return get_field("ministry_groups_back_button", "options");
}
