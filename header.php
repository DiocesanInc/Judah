...
<?php
$blurred = get_field("menu_colors", "options")["top_level_default"]["blurry_background"] ? " header-blurred" : "";
$blurred_sticky = get_field("menu_colors", "options")["top_level_sticky"]["blurry_background"] ? " header-blurred-sticky" : ""; ?>

<body <?php body_class("judah-hybrid"); ?>>
    <?php wp_body_open(); ?>
    <div id="page" class="site">
        <a class="skip-link screen-reader-text" href="#primary">
            <?php esc_html_e('Skip to content', 'evoli'); ?>
        </a>

        <header id="masthead" class="site-header<?php echo "$blurred$blurred_sticky"; ?>">
