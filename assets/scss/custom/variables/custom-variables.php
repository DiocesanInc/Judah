...
$variables->addCssRule(
    ":root",
    array("--clr-body" => get_field("body_background_color", "options"))
);
...
if (!get_field("menu_colors", "options")["top_level_default"]["blurry_background"]) {
...
if (!get_field("menu_colors", "options")["top_level_sticky"]["blurry_background"]) {
 ...
 */
if (get_field("body_background_color", "options") === "white") :
    $variables->addCssRule(
    ...
    $variables->addCssRule(
        ...
        .parish-cluster .parishButtons .featured-button:hover::before",
        array(
            "opacity" => "0.4"
        )
    );
    ...
    $variables->addCssRule(
        ...
        .parish-scroll-title, .news-heading",
        array(
            "color" => "black"
        )
    );
